...
public class GestioneSpeseAdapterRV extends RecyclerView.Adapter<GestioneSpeseAdapterRV.MyViewHolder>{
    ...
    public GestioneSpeseAdapterRV(Context appContext, String[] nomeCategoriaSpesa, int[] iconaCategoriaSpesa){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = inflater.inflate(R.layout.item_spese,parent,false);
